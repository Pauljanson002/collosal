...
class Trainer:
    ...
    def train_one_epoch(self,epoch):
        ...
        loss = loss + self.guidance.train_step(text_z,text_z_ref, image,self.ref_image, guidance_scale=15, as_latent=True, grad_scale=1,save_guidance_path=None)
       # loss = loss + self.guidance.train_step(text_z,text_z_ref,image,self.ref_image,as_latent=True,guidance_scale=self.args.guidance_scale,grad_scale=self.args.lambda_guidance,save_guidance_path="/home/paulj/projects/collosal/guidance/image.png")
