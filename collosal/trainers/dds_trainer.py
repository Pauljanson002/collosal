...
class Trainer:
    ...
    def train_one_epoch(self,epoch):
        ...
        loss = loss + self.guidance.train_step(text_z,image,self.ref_image,as_latent=False,guidance_scale=self.args.guidance_scale,grad_scale=self.args.lambda_guidance,save_guidance_path="/home/paulj/projects/collosal/guidance/image.png")
