...
def main(model_folder,
    ...
    if plotting_module == "pytorch3d":
        ...
        from pytorch3d.renderer import (
            ...
            look_at_view_transform,PointLights
        )
        faces = torch.from_numpy(model.faces.astype(int)).squeeze().to("cuda:0")
        mesh = Meshes(verts=[output["vertices"]], faces=faces)
